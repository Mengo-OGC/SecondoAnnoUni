...
\definizione{Covarianza}{La covarianza di $x$ e $y$ è \[\sigma_{x,y}=\frac{1}{n}\sum_{i=1}^n(x_i-\overline{x})(y_i-\overline{y})=\overline{xy}-\overline{x}\cdot \overline{y}\]}{d:covarianza}
...
\dimostrazione{d:covarianza}{\begin{align*}
	...
	&=\frac{1}{n}\sum_{i=1}^n(x_iy_i)-x_i\overline{y}-\overline{x}y_i+\overline{xy}\\
	&=\overline{xy}-\overline{x}\cdot\overline{y}-\overline{x}\cdot\overline{y}+\overline{x}\cdot\overline{y}\\
