class UseTrain {
    public static void main(String[] args) {
         ...
         * occupazione
         */
        MyTrain ut = new MyTrain();
        ut.build(100,40, 60);
        ut.reserveFirstClassSeats(34);
        ut.reserveSecondClassSeats(23);
        System.out.println("percentuale prima classe: " + ut.getFirstClassOccupancyRatio());
        System.out.println("percentuale seconda classe: " + ut.getSecondClassOccupancyRatio());
        ut.deleteAllReservations();
        ut.reserveFirstClassSeats(35);
        ut.reserveSecondClassSeats(56);
        System.out.println("percentuale prima classe: " + ut.getFirstClassOccupancyRatio());
        System.out.println("percentuale seconda classe: " + ut.getSecondClassOccupancyRatio());
        System.out.println("percentuale totale: " + ut.getTotOccupancyRatio());
