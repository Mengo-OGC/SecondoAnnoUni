...
\textbf{Interfaccia funzionale}: Interfaccia con un singolo metodo non default (può avere più metodi default). \inline{@FunctionalInterface} annotazione opzionale.

\subsubsection{Metodi default}
Le interfacce possono fornire implementazioni di default, da non implementare nelle sotto classi, di metodi statici/non statici.

\oneline{interface <name> \{... default <firmaMetodo>\{...\} ...\}}
...
\begin{enumerate}
	...
	\end{figure}
	\item \textbf{Decorator}: Aggiunge/sovrascrive funzionalità di classi presistenti.

	Sia A classe che implementa l'interfaccia I. Un decoratore D è una classe astratta che implementa e si compone di I.
	D sarà implementato da più classi concrete.
	\begin{figure}[H]
		\centering
	\includegraphics[width=0.5\textwidth]{patternDecorator.png}
	\end{figure}
	Si può usare D ogni volta che si userebbe A, ma con funzinalità in più (e comportamenti possibilmente modificati).

	I decoratori si possono combinare, dando a D2 come parametro D1.
\end{enumerate}
