...
\subsection{throws}
Dichiara che il metodo può lanciare una o più eccezzioni checked e delegarne la gestione al chiamante.

Il chiamante o gestisce l'eccezione con \inline{try-catch} oppure "rimpalla" l'eccezione a sua volta con \inline{trows}.
