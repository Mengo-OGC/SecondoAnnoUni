...
\begin{itemize}
	...
	\item Per dimensionare relativamente al container la gui.
	...
	\item Un oggetto di \inline{ClassLoader} secondo \textit{location-independent} carica le risorse del classpath:
	\begin{itemize}
		\item \inline{ClassLoader.getSystemClassLoader();}
		\item \inline{ClassLoader.getSystemResourceAsStream("nomeRisorsa");}
		\item \inline{ClassLoader.getSystemResource("nomeRisorsa");}
		\item \inline{getResource();}
	\end{itemize}
