...
\tabella{Utilities}{
	...
	\riga{sed \textit{modlaità file}}{Modifica il testo secondo una regola. Modalità:
	\begin{itemize}
		\item \textbf{'s/originale/nuovo/g'} sostituisce il testo originale (o più testi orinali con [o1, o2, ...]) con quello nuovo. Con l'opzione g si dice di applicarlo per tutte le occorrenze trovate e non solo la prima.
	\end{itemize}}
...
\tabella{Vari}{
	...
	\begin{itemize}
		...
		\item \textbf{-tipe f} Trova solo file.
