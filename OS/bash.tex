...
\tabella{Uso File Descriptor}{
	...
	\riga{\textit{program} modalità \textit{file}}{Ridirezionamento input/output.
...
\tabella{Standard input e output}{
	...
	\begin{itemize}
		\item \textbf{-n \textbf{numero}} Numero massimo di caratteri da leggere.

		\item \textbf{-N \textit{numero}} Numero esattto di caratteri da leggere.
	...
	\riga{echo "..." 1$>$\&\${var}}{Scrive sul file di file descriptor in var.}
}
