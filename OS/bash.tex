...
\tabella{Uso File Descriptor}{
	...
	\riga{program \textit{modalità file}}{Ridirezionamento input/output.
	...
	\riga{program \textit{modalità1 file1 modalità2 file2}}{Si possono fare contemporaneamente i ridirezionamenti I/O. L'ordine di specificazione non conta.}
