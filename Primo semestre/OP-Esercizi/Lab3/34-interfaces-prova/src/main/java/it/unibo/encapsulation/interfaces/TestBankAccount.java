...
public class TestBankAccount {
    ...
    public static void main(final String[] args) {
        ...
        BankAccount b2 = new StrictBankAccount(1, 0);
        /*
         ...
         */
        System.out.println("Conto di Rossi: " + b1.getBalance());
        System.out.println("Conto di Bianchi: " + b2.getBalance());
        /*
         ...
         */
        b1.computeManagementFees();
        b2.computeManagementFees();
        /*
